    ...
    <div class="kanban-column">
        <div class="column-header">
            <div class="column-title">
                ...
                <div class="title-content">
                    <h3>Not Started</h3>
                    <span class="task-count">{{ notStartedTasks.length }} tasks</span>
                </div>
            </div>
        ...
        <div class="column-content">
            <div class="tasks-container">
                <div v-if="notStartedTasks.length === 0" class="empty-state">
                    <div class="empty-icon">
                        <i class="fas fa-inbox"></i>
                    </div>
                    <p>No tasks yet</p>
                    <button @click="openTaskModal" class="add-first-task-btn">
                        <i class="fas fa-plus"></i>
                        Add First Task
                    </button>
                </div>
                ...
                <div v-else class="task-list">
                    <div v-for="task in notStartedTasks" :key="task.id" class="task-card" draggable="true"
