                ...
                <form enctype="multipart/form-data" @submit.prevent="submitTask">
                    ...
                    <div class="modal-body">
                        <div class="select-members">
                            <span v-for="member in selectedMembers" @click="unSelectedMember(member.id)"
                                :key="member.id">
                                {{ member.name }} <b>x</b>
                            </span>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <BaseBtn :loading="false" label="Add Task" />
                                </div>
                            </div>
                            <br />
                            <br />
                        ...
                        <table class="table table table-hover table-sm">
                            ...
                            <tr v-for="member in members?.data?.data" :key="member.id">
                                ...
                                <td>{{ member.name }}</td>
                                <td>
                                    <button @click="selectMember(member)" type="button" class="btn btn-light" style="
                                            border-radius: 10px;
